...
## Mar27_2_AJAXServer/pom.xml

C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\pom.xml
...
<project xmlns="http://apache.org" xmlns:xsi="http://w3.org"
	...
	<artifactId>may212</artifactId>
	<name>May27_2_AJAXServer</name>
	...
	<repositories>
		...
		<repository>
			...
			<url>http://jahia.org</url>
		</repository>
		<!-- 전자정부 프레임워크 공식 저장소 (추가됨) -->
		<repository>
			<id>egovframe</id>
			<url>https://egovframe.go.kr</url>
			<releases>
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\webapp\WEB-INF\spring\appServlet\servlet-context.xml
...
<beans:beans xmlns="http://www.springframework.org/schema/mvc"
	...
	<context:component-scan base-package="com.beaver.may272" />
	...
	<beans:bean id="sqlSessionFactory" class="org.mybatis.spring.SqlSessionFactoryBean">
		<beans:property name="dataSource" ref="dataSource" />
		<beans:property name="typeAliasesPackage" value="com.beaver.may272" />
		<beans:property name="mapperLocations" value="classpath:com/beaver/may272/fruit/FruitMapper.xml" />
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\webapp\WEB-INF\web.xml
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\java\com\beaver\may272\HomeController.java

```java
package com.beaver.may272;
...
import com.beaver.may272.fruit.FruitDAO;
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\java\com\beaver\may272\fruit\FruitDAO.java
...
public class FruitDAO {
	...
	public void getAllFruit(HttpServletRequest req) {
		try {
			List<Fruit> fruits =
					ss.getMapper(FruitMapper.class).getAllFruit();
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\java\com\beaver\may272\fruit\Fruit.java
...
public class Fruit {
	...
	public Fruit(String f_name, String f_price) {
		super();
		this.f_name = f_name;
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\java\com\beaver\may272\fruit\FruitMapper.java
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\resources\com\beaver\may272\fruit\FruitMapper.xml

```xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE mapper PUBLIC "-//mybatis.org//DTD Mapper 3.0//EN" "http://mybatis.org/dtd/mybatis-3-mapper.dtd">
<mapper namespace="com.beaver.may272.fruit.FruitMapper">

	<select id="getAllFruit" resultType="com.beaver.may272.fruit.Fruit">
		select * from may21_fruit order by f_price <!-- ; 를 마지막에 기입하면 오류가 발생함 -->
	</select>
</mapper>
```
...
```sql
create table may21_fruit(
	f_name varchar2(10 char) primary key,
	f_price number(5) not null
);
select * from may21_fruit;
-- 데이터 5-6개 insert
insert into MAY21_FRUIT (f_name, f_price) values ('귤', 2800);
insert into MAY21_FRUIT (f_name, f_price) values ('바나나', 3800);
insert into MAY21_FRUIT (f_name, f_price) values ('사과', 4800);
insert into MAY21_FRUIT (f_name, f_price) values ('망고', 3500);
insert into MAY21_FRUIT (f_name, f_price) values ('체리', 2700);
insert into MAY21_FRUIT (f_name, f_price) values ('키위', 2000);
```

## index.jsp

C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\webapp\WEB-INF\views\index.jsp
	 	...
	 	<hr>
	 		<div id="contents">
		 		<c:forEach var="fruit" items="${fruits}">
		 			${fruit.f_name } - ₩ <fmt:formatNumber value="${fruit.f_price }" pattern="#,###" /><hr>
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\java\com\beaver\may272\fruit\Fruits.java
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\java\com\beaver\may272\fruit\FruitController.java
...
C:\Users\sdedu01\Desktop\Test\20260518_eGov\Mar27_2_AJAXServer\src\main\webapp\WEB-INF\views\index2.jsp
...
<script type="text/javascript">
	...
	//	})   --> 이 부분을 빼놓으면 실행이 안된다. 
		...
		$("#regBtn").click(function() {
			...
			let tb1 = $("<td></td>").text(title);
			let tb2 = $("<td></td>").text(price);
...
<body>
	메뉴 : <input type="text" id="title"> <p>
	가격 : <input type="text" id="price"> <p>
...
<script type="text/javascript">
		$(function() {
			// 선택자를 지정하지 않았을때
			//	특정 DOM, 객체를 어떻게 찾아낼것인가?
			$("button").click(function colour() {
				// colour라는 이름처럼 고유의 이름을 지어주지 않으면, 기능 작동 실패.
				//$("button").css("background-color", "red");
				
				// $(this) : 클릭 이벤트 발생함수인 colour()를 호출한 장본인
				//				누른 버튼에 대해서만 해당하는 명령을 실행할 수 있음.
				$(this).css("background-color", "red")
				
				// 누른 버튼이 있는 td 에 배경색을 주기
				//$("td").css("background-color", "#227799"); //teal(colour) 
				
				// .parent() : 사용자가 누른 this의 한단계 상위 DOM객체 
				//				cf) 그 반대로는 children() 
				$(this).parent().css("background-color", "#227799");
			
				// 눌린 버튼이 있는 table의 테두리를 파란색으로!
				//$(this).parent().parent().parent().parent().css("border", "blue solid 3px");  // 개발자도구 필수 
				// closest("선택자") 
				// : 상위에 있는 객체들 중에서 가장 가까운 CSS 선택자
				// cf) find("선택자")
				// : 하위에 있는 객체들 중에서 가장 가까운 CSS 선택자 
				$(this).closest("table").css("border", "blue solid 3px");
				
				// td를 클릭했을 때 눌려진 td의 배경색이 노란색...
				$("td").click(function() {
					$(this).css("background-color", "yellow"); 
				
				// td 를 클릭했을 때 그 td 속에 있는 모든 것들의 배경색이 핑크색
					$(this).children().css("background-color", "pink");
				
				// td 를 클릭했을 때 그 td 속에 있는 버튼의 테두리색 빨간 색
				$(this).find("button").css("border", "red solid 3px");
				})
				
				// input 에 쓴 글자가 (입력하고 버튼 눌렀을 때)
				//	버튼 글자색이 되도록!
				$("button").click(function() {
					// 버튼을 클릭했을 때, input의 값을 받아올수 있어야!
					//let c = $(this).parent().find("input").val();
					//alert(c);
					
					// siblings() : 동일선상에 있는 특정 선택자 
...
<script type="text/javascript">
	$(function() {
		...
		// input 에서 keyboard를 누르면 >> 누른 순간에
		/*
		$("input").keydown(function() {
			$("h1").text("키보드를 누르는 동안");
			return false; // 기능을 발동하기전에
							// return false; 가 있으면,
							// 원래 기능을 못하게 막아버릴수 있음 
		});
		*/
		
		// 특정 키를 눌렀을 때 뭔가 하고싶다면...
		$("input").keydown(function(e) {
			// 키보드 아스키값 : 모든 키에는 고유한 값이 있음
			$("h1").text(e.keyCode);
		
		if (e.keyCode == 13) { // enter키 : 13
			alert("와우 ~");
...
<script type="text/javascript">
	$(function() {
		...
		// 마우스 우클릭을 했다면
		//	클릭한 위치에 table이 나타났다가 3초뒤에 사라지면서
		//	0.3초 뒤에 table이 원위치로 돌아가게
		
		let timeout; // 마지막 클릭 상태를 얻어내기 위한 변수
		let timeout2;
		$("html").mousedown(function(e) {
			if (e.button == 2) { //우클릭을 했다면
				$("table").css("opacity", "1")
						  .css("left", e.pageX + "px")
						  .css("top", e.pageY + "px");  
				
			}
			clearTimeout(timeout); //상태초기화
			clearTimeout(timeout2); //상태초기화
			
			timeout = setTimeout(() => { //(()여기에서 오류가 날 경우, () 괄호 우측에서 )을 추가하지말고, 좌측에서 (를 추가하는게 좀더 합리적일때도 있다.
				$("table").css("opacity", "0");
				timeout2 = setTimeout(() => {
...
<body>
	...
	<table border = "1">
		<tr>
			...
			<td>
				<a href="https://www.youtube.com">유튜브로</a>
			</td>
	...
	$(function() {
		...
		*/
			if (t === "직접입력") {
				...
				$("div").empty(); // 이 부분이 담당하는 것 : input 무한 생성 방지 
